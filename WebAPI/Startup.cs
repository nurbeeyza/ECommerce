...
namespace WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ECommerceDbContext>(opts => opts.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=ECommerceProject; Trusted_Connection=True;", options => options.MigrationsAssembly("DataAccess").MigrationsHistoryTable(HistoryRepository.DefaultTableName, "dbo")));
